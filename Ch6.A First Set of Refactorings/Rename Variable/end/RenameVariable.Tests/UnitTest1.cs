...
namespace RenameVariable.Tests
{
    public class Tests
    {
        ...
        {
            // arrange & act
            string myHeight = "Today's height is " + EncapsulatingVariableExample.Height;
            EncapsulatingVariableExample.Height = 800;

            // assert
            Assert.AreEqual("Today's height is 999", myHeight);
            Assert.AreEqual(800, EncapsulatingVariableExample.Height);
        }
        ...
        public void Call_RenamingAConstantExample_Constant_Correctly()
        {
            ...
            Assert.AreEqual("Code Paradise Road", RenamingAConstantExample.Address);
        }
    }
}